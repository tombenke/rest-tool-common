...
var setDefaults = function(rawServiceDescriptor) {
    var serviceDescriptor = rawServiceDescriptor;
    ...
    // console.log(JSON.stringify(serviceDescriptor, null, '  '));
...
var loadServices = function(restapiRoot, servicesRoot, servicesToLoad) {
    ...
    servicesToLoad.forEach(function (servicePath) {
        ...
        if (err.length > 0 ) {
            ...
            serviceDescriptor = setDefaults(serviceDescriptor);
