...
export const flattenServerProtocols = servers => _.flatMap(servers, server => _.map(server.protocols, protocol => ({
    protocol: protocol,
    port: server.port,
...
export const getOpenApiServers = oasApi => _.map(_.get(oasApi, 'servers', [{
